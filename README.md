...
The LED on the watchdog board is also used to indicate when the watchdog is in its start-up delay phase, bu lighting the LED constantly during this period.
